...
public class TelaRelogio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/calendariopng.jpg"))); // NOI18N
        jLabel1.setText("jLabel1");

        jLabel2.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jLabel2.setText("Data e Hora Atuais");

        lblHora.setFont(new java.awt.Font("Dialog", 0, 13)); // NOI18N
        lblHora.setText("Clique no botão");

        btnHora.setText("Clique aqui!");
        btnHora.setActionCommand("Cli");
